...
function getMaxConcurrent() {
  const n = Number(process.env.MAX_CONCURRENT_CLI);
...
function serializedByUser(username, fn) {
...
module.exports = { serializedByUser, withConcurrencyLimit, maxConcurrentCli };
